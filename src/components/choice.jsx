    ...
    <>
      {winnerEffect ? (
        <div className="relative">
          <div className="animate-pulseCustom absolute left-1/2 top-1/2 h-[160%] w-[160%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white opacity-[0.03]"></div>
          <div className="animate-pulseCustom absolute left-1/2 top-1/2 h-[220%] w-[220%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white opacity-[0.02]"></div>
          <div className="animate-pulseCustom absolute left-1/2 top-1/2 h-[290%] w-[290%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white opacity-[0.01]"></div>
          <div
            className={`${
              choice === "rock"
